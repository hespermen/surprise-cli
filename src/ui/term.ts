...
// Считано по частям интерфейса: логотип 5, измеритель 3, плеер 5, подсказка 1,
// и не меньше 20 строк телу, иначе список и подробности сжимаются до нечитаемых.
// Прежние 34 не вмещали всё сразу, и терминал начинал прокручивать содержимое.
