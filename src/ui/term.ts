...
// абсолютный минимум, при котором её не режет. Прежние 100 обрезали её на
// последнем слове, что и было видно на экране. Берём 104 — запас на случай
// более длинной подсказки после перевода.
//
// Высота: логотип 5, измеритель 3, плеер 5, подсказка 1 — четырнадцать строк
// занято всегда. Остальное делят список и подробности; на 44 строках списку
// достаётся 13 строк данных, подробностям — 11, и обе панели выглядят
// наполненными, а не сплюснутыми.
